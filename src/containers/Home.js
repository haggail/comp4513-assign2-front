        ...
        return(
                <article className="section columns is-mobile">
                    <div className="column is-three-fifths is-offset-one-fifth">
                        <HomeCard cl="hero is-primary is-bold" link="/portfolio" title="Browse Portfolios" sub="Browse your portfolio"/>
                        ...
                        <HomeCard cl="hero is-primary is-bold" link="/about" title="About Us" sub="Find out more about our system"/>
                    </div>
                </article>
            );
    }
